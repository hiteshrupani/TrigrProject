...
var tempRestaurant: [Restaurant] = [
    ...
    Restaurant(profileImage: "wowchina", name: "Wow! China", cuisine: "Chinese, Tibetan, Snacks, Continental", rating: 3.9, averageExpense: "8 - 10", timeToDeliver: 55,isPopular: true),
